...
#ifndef __CESVGA2ACCEL_H__
#define __CESVGA2ACCEL_H__
...
class CEsvga2Accel : public IOAccelerator
{
	OSDeclareDefaultStructors(CEsvga2Accel);
...
private:
	...
	SVGA3D svga3d;
	SVGAScreen screen;
	class CEsvga2* m_framebuffer;
	SVGADevice* m_svga;
	IODeviceMemory* m_vram;
	IOMemoryMap* m_vram_kernel_map;
	class CEsvga2Allocator* m_allocator;
	IOLock* m_iolock;
#ifdef FB_NOTIFIER
...
public:
	...
	/*
	 * Methods for supporting CEsvga22DContext
	 */
	...
	/*
	 * Methods for supporting CEsvga2Surface
	 */
	struct ExtraInfo {
	...
	class CEsvga2Surface* findSurfaceForID(uint32_t surface_id);
	SVGA3D* lock3D();
	void unlock3D();
